...
export function setColorPickerResizeState(state) {
    ...
    if (state.initialWidth !== undefined) cpResizeInitialWidth = state.initialWidth;
    if (state.initialHeight !== undefined) cpResizeInitialHeight = state.initialHeight;
}
...
export function setPopoutResizeState(state) {
    ...
    if (state.initialHeight !== undefined) resizeInitialHeight = state.initialHeight;
}
