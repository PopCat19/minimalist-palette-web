...
export let cpResizeStartX, cpResizeStartY, cpResizeInitialWidth, cpResizeInitialHeight;
...
export function setColorPickerState(state) {
    if (state.targetRow !== undefined)
        pickerTargetRow = state.targetRow;
    if (state.targetCol !== undefined)
        pickerTargetCol = state.targetCol;
    if (state.isUpdating !== undefined)
        isPickerUpdating = state.isUpdating;
}
...
export function setColorPickerDragState(state) {
    ...
    if (state.startX !== undefined)
        pickerStartX = state.startX;
    if (state.startY !== undefined)
        pickerStartY = state.startY;
    if (state.initialX !== undefined)
        pickerInitialX = state.initialX;
    if (state.initialY !== undefined)
        pickerInitialY = state.initialY;
}
export function setColorPickerResizeState(state) {
    isResizingColorPicker = state.isResizing;
    if (state.startX !== undefined)
        cpResizeStartX = state.startX;
    if (state.startY !== undefined)
        cpResizeStartY = state.startY;
...
export function setPopoutDragState(state) {
    ...
    if (state.startX !== undefined)
        popoutStartX = state.startX;
    if (state.startY !== undefined)
        popoutStartY = state.startY;
    if (state.initialX !== undefined)
        popoutInitialX = state.initialX;
    if (state.initialY !== undefined)
        popoutInitialY = state.initialY;
}
export function setPopoutResizeState(state) {
    isResizingPopout = state.isResizing;
    if (state.startX !== undefined)
        resizeStartX = state.startX;
    if (state.startY !== undefined)
        resizeStartY = state.startY;
    if (state.initialWidth !== undefined)
        resizeInitialWidth = state.initialWidth;
    if (state.initialHeight !== undefined)
